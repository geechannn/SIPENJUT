...
<!-- modal edit -->
<div class="modal fade" id="modal-edit<?php echo $data['id_kriteria']; ?>">
      ...
      <div class="modal-body">
        <form method="POST" action="edit_kriteria.php">
          ...
          <div class="form-group">
            ...
            <input name="nama_kriteria" type="text" class="form-control" id="nama_kriteria" placeholder="nama_kriteria" value="<?php echo $data['nama_kriteria']; ?>" required />
          </div>
...
<!-- /.modal -->     
              ...
              <center> 
                      <a data-toggle="modal" data-target="#modal-edit<?php echo $data["id_kriteria"]; ?>" class="btn btn-outline-primary" > Edit</a>

                      <a href="hapus_kriteria.php?id_kriteria=<?php echo $data["id_kriteria"]; ?>" class="btn btn-outline-danger" > Hapus</a>
              </center>
            </div>
          </div>
        </td>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" action="tambah_kriteria.php">
              ...
              <div class="form-group">
                <label>Nama Kriteria</label>
                <input  name="nama_kriteria" type="text" class="form-control" id="nama_kriteria" placeholder="Input Nama Kriteria!" required />
              </div>
              <!-- </div> -->
