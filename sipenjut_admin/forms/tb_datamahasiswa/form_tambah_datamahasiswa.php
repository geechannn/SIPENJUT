...
<div class="w-50 mx-auto border p-3 mt-5">
  <h4 class="mb"><i class="fa fa-angle-right"></i> Input Data Mahasiswa</h4>
    <form action="tambah_datamahasiswa.php" method="POST">
      ...
      <label for="id_golongan_uktawal">Id Kelompok UKT Awal</label>           
            <select class="custom-select" id="id_golongan_uktawal" name="id_golongan_uktawal" placeholder="Input Kelompok UKT anda saat ini!" required >
