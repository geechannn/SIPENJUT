    ...
    <div class="content-wrapper">
     ...
     <div class="card">
        <div class="card-header">
          <h3 class="card-title">Berikut merupakan data mahasiswa untuk peninjauan ulang UKT</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
...
<!-- modal edit -->
<div class="modal fade" id="modal-edit<?php echo $data['nim']; ?>">
      ...
      <div class="modal-body">
        <form method="POST" action="edit_mahasiswa.php">
          <div class="form-group">
            <label>NIM</label>
            <input name="nim" type="text" class="form-control" id="nim" placeholder="" value="<?php echo $data['nim']; ?>" readonly />
          </div>
          ...
          <div class="form-group">
            <label>Nama</label>
            <input name="nama_mhs" type="text" class="form-control" id="nama_mhs" placeholder="Input Nama Mahasiswa" value="<?php echo $data['nama_mhs']; ?>" required />
          </div>
...
<!-- /.modal -->     
              ...
              <center> 
                      <a data-toggle="modal" data-target="#modal-edit<?php echo $data["nim"]; ?>" class="btn btn-outline-primary" > Edit</a>

                      <a href="hapus_mahasiswa.php?nim=<?php echo $data["nim"]; ?>" class="btn btn-outline-danger" > Hapus</a>
              </center>
            </div>
          </div>
        </td>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" action="tambah_mahasiswa.php">
              ...
              <div class="form-group">
                <label>NIM</label>
                <input name="nim" type="text" class="form-control" id="nim" placeholder="Input NIM!" required />
              </div>
              ...
              <div class="form-group">
                <label>Nama</label>
                <input  name="nama_mhs" type="text" class="form-control" id="nama_mhs" placeholder="Input Nama Mahasiswa!" required />
              </div>
              <!-- </div> -->
